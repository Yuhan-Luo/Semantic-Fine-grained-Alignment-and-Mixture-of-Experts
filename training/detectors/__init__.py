...
from .clip_detector_with_text import CLIPTextDetector
from .fake_segment import CLIP16x16Segmentor
from .clip_detector_vit_L import CLIPDetector_vit_L
from .fake_segment_vit_L import CLIP16x16Segmentor_vit_L
from .fake_segment_MSE import CLIP16x16Segmentor_MSE
from .fake_segment_register import CLIP16x16Segmentor_register
from .effort_detector import EffortDetector
from .fake_segment_MSE_MOE import CLIP16x16Segmentor_MSE_moe
from .fake_segment_MSE_MOE_k import CLIP16x16Segmentor_MSE_moe_k
